  ...
  return (
    <footer className="relative border-t border-neutral-800 bg-neutral-950 text-neutral-300">
      <button
        ...
        className="absolute left-1/2 top-0 flex h-12 w-12 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-white/10 bg-trust-blue-700 text-white shadow-lg transition-transform hover:scale-105"
